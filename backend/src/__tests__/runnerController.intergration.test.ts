...
const mockedValidationService = validationService as jest.Mocked<
...
describe("RunnerController Integration Tests", () => {
  ...
  describe("POST /runners/register", () => {
    ...
    it("should register runner successfully with valid data", async () => {
      ...
      expect(
        mockedValidationService.validateRunnerRegistration
      ).toHaveBeenCalledWith(validRunnerData);
      ...
      expect(mockedRunnerService.createRunnerProfile).toHaveBeenCalledWith(
        1,
        validRunnerData
      );
    });
    ...
    it("should return 400 if runner already exists", async () => {
      ...
      expect(response.body.message).toBe(
        "You are already registered as a runner"
      );
    });
    ...
    it("should handle service errors appropriately", async () => {
      ...
      mockedRunnerService.checkExistingRunner.mockRejectedValue(
  ...
  describe("GET /runners/profile", () => {
    it("should return runner profile successfully", async () => {
      ...
      mockedRunnerService.getRunnerByUserId.mockResolvedValue(
        mockRunner as any
      );
      mockedRunnerService.getRunnerStatistics.mockResolvedValue(
        mockStatistics as any
      );

      const response = await request(app).get("/runners/profile").expect(200);
    ...
    it("should return 404 if runner profile not found", async () => {
      ...
      const response = await request(app).get("/runners/profile").expect(404);
    ...
    it("should handle service errors for getRunnerProfile", async () => {
      mockedRunnerService.getRunnerByUserId.mockRejectedValue(
        new Error("Database error")
      );

      const response = await request(app).get("/runners/profile").expect(500);
  ...
  describe("PUT /runners/profile", () => {
    ...
    it("should update runner profile successfully", async () => {
      ...
      mockedRunnerService.updateRunnerProfile.mockResolvedValue(
        updatedRunner as any
      );
      ...
      expect(mockedValidationService.validateRunnerUpdate).toHaveBeenCalledWith(
        validUpdateData
      );
      expect(mockedRunnerService.updateRunnerProfile).toHaveBeenCalledWith(
        1,
        validUpdateData
      );
    });
  ...
  describe("GET /runners/nearby", () => {
    it("should return nearby runners with pagination", async () => {
      ...
      expect(mockedRunnerService.getNearbyRunners).toHaveBeenCalledWith(
        "Downtown",
        1,
        10
      );
    ...
    it("should use default pagination values when not provided", async () => {
      ...
      const response = await request(app).get("/runners/nearby").expect(200);
    ...
    it("should handle service errors", async () => {
      mockedRunnerService.getNearbyRunners.mockRejectedValue(
        new Error("Database error")
      );

      const response = await request(app).get("/runners/nearby").expect(500);
  ...
  describe("GET /runners/dashboard", () => {
    it("should return runner dashboard data successfully", async () => {
      ...
      mockedRunnerService.getRunnerDashboard.mockResolvedValue(
        mockDashboardData as any
      );

      const response = await request(app).get("/runners/dashboard").expect(200);
    ...
    it("should return 404 if runner profile not found for dashboard", async () => {
      ...
      const response = await request(app).get("/runners/dashboard").expect(404);
    ...
    it("should handle service errors for dashboard", async () => {
      ...
      const response = await request(app).get("/runners/dashboard").expect(500);
  ...
  describe("GET /runners/earnings", () => {
    it("should return earnings breakdown for specified period", async () => {
      ...
      mockedRunnerService.getEarningsBreakdown.mockResolvedValue(
        mockEarnings as any
      );
      ...
      expect(mockedRunnerService.getEarningsBreakdown).toHaveBeenCalledWith(
        1,
        "month"
      );
    });
    ...
    it("should use default period when not specified", async () => {
      ...
      const response = await request(app).get("/runners/earnings").expect(200);
    ...
    it("should handle service errors for earnings", async () => {
      mockedRunnerService.getEarningsBreakdown.mockRejectedValue(
        new Error("Database error")
      );

      const response = await request(app).get("/runners/earnings").expect(500);
